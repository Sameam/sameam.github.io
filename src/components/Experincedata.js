const work = [
  {
    ...
    "date":"10-12-2021 to Current",
    "name":"Freelance",
    "description":"Perform web scraping to get the dataset, processing the dataset with visualization, use Machine learning algorithm to train and predict the dataset. Finally, check, deploy maintain and update the model."
  }, 
  {
    "title":"Coaching",
    "date":"10-12-2018 to 02-02-2019",
